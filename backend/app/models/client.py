...
class Client(Base):
    ...
    blog_ideas = relationship("BlogIdea", back_populates="client", cascade="all, delete-orphan")
    backlink_opportunities = relationship("BacklinkOpportunity", back_populates="client", cascade="all, delete-orphan")
    content_clusters = relationship("ContentCluster", back_populates="client", cascade="all, delete-orphan")
